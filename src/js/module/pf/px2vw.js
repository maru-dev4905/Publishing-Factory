...
export const px2vw = {
  root: null,
    ...
    cache() {
      ...
      this.els = {
        // 숫자 변환 박스
        boxPx2Vw: Dom.q('[data-box="px2vw"]', r),
        boxVw2Px: Dom.q('[data-box="vw2px"]', r),

        inPx: Dom.q('[data-input="px"]', r),
        inVw: Dom.q('[data-input="vw"]', r),
        inBase1: Dom.q('[data-input="base1"]', r), // px→vw 기준 뷰포트
        inBase2: Dom.q('[data-input="base2"]', r), // vw→px 기준 뷰포트
        inDec1: Dom.q('[data-input="dec1"]', r),  // 소수 자리수

        outVw: Dom.q('[data-output="vw"]', r),
        outPx: Dom.q('[data-output="px"]', r),

        // CSS 변환 박스
        boxCssPx2Vw: Dom.q('[data-box="css-px2vw"]', r),
        boxCssVw2Px: Dom.q('[data-box="css-vw2px"]', r),

        taSrc1: Dom.q('[data-ta="src1"]', r),
        taOut1: Dom.q('[data-ta="out1"]', r),
        inBase3: Dom.q('[data-input="base3"]', r), // css px→vw 기준 뷰포트
        inDecCss: Dom.q('[data-input="dec-css"]', r),
        chkStrip1: Dom.q('[data-chk="strip1"]', r),

        taSrc2: Dom.q('[data-ta="src2"]', r),
        taOut2: Dom.q('[data-ta="out2"]', r),
        inBase4: Dom.q('[data-input="base4"]', r), // css vw→px 기준 뷰포트
        chkStrip2: Dom.q('[data-chk="strip2"]', r),
      };
    },
